...
A few years ago, I made [a LaTeX beamer theme](https://github.com/WannabeSmith/beamertheme-pittsburgh/) for presentations. In a nutshell, I came to appreciate the types of slides that could be made in Keynote but noticed three shortcomings:
...
Points 2 and 3 are minor annoyances but 1 is a deal-breaker for some. Fortunately, beamer is cross-platform, space-efficient, and math fonts are obviously native. However, I could not find a theme with the aesthetic sensibilities of Keynote so I attempted to make one and have been using it ever since. Some screenshots of demo slides can be found below.
